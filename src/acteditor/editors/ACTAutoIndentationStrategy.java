...
/*
 * This implementation is from org.eclipse.ui.examples.javaeditor.java.JavaAutoIndentStrategy,
 * since indentation in java and ACT follow almost the same rules.
 */
...
public class ACTAutoIndentationStrategy extends DefaultIndentLineAutoEditStrategy {

	public ACTAutoIndentationStrategy() {
		// nothing
	}
	 ...
	 * @param txt the text
	 * @return <code>true</code> if <code>txt</code> ends with one of the document's
	 *         line delimiters, <code>false</code> otherwise
	 */
	...
	/**
	 * Returns the bracket value of a section of text. Closing brackets have a value
	 * of -1 and open brackets have a value of 1.
	 *
	 * @param document            - the document being parsed
	 * @param start               - the start position for the search
	 * @param end                 - the end position for the search
	 * @param ignoreCloseBrackets - whether or not to ignore closing brackets in the
	 *                            count
	 ...
	 * @throws BadLocationException in case <code>position</code> is invalid in the
	 *                              document
	 */
